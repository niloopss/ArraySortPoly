/**
 * Classe que representa um arranjo de números inteiros (int[]), estendendo a classe abstrata {@link Arranjo}.
 * Permite armazenar e classificar um conjunto de valores do tipo int.
 *
 * @author Nivea Lins
 */
public class ArranjoInteiro extends Arranjo<Integer> {
    ...
    /**
     * Array para armazenar os elementos do tipo int.
     */
    private int[] elementos;

    /**
     * Constrói um novo objeto ArranjoInteiro com o tamanho especificado.
     *
